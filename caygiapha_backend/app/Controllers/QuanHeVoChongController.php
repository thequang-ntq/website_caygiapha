...
class QuanHeVoChongController extends ResourceController
{
    protected $modelName = 'App\Models\QuanHeVoChongModel';
    protected $format    = 'json';

    // Lấy danh sách tất cả quan hệ vợ chồng
